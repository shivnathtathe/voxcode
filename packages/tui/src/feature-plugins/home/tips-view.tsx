...
const TIPS: Tip[] = [
  ...
  "Create a plugin to prevent VoxCode from reading sensitive files",
  "Use {highlight}voxcode run{/highlight} for non-interactive scripting",
  "Use {highlight}voxcode --continue{/highlight} to resume the last session",
  "Use {highlight}voxcode run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}voxcode serve{/highlight} for headless API access to VoxCode",
  "Use {highlight}voxcode run --attach{/highlight} to connect to a running server",
  "Run {highlight}voxcode upgrade{/highlight} to update to the latest version",
  "Run {highlight}voxcode auth list{/highlight} to see all configured providers",
  "Run {highlight}voxcode agent create{/highlight} for guided agent creation",
  "Use {highlight}/opencode{/highlight} in GitHub issues/PRs to trigger AI actions",
  "Run {highlight}voxcode github install{/highlight} to set up the GitHub workflow",
  ...
  "Run {highlight}voxcode debug config{/highlight} to troubleshoot configuration",
  ...
  "Use {highlight}/connect{/highlight} with VoxCode Zen for curated, tested models",
